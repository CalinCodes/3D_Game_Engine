...
Camera::Camera()
{
	position = Vector3(0.0f, 0.0f, -500.0f); target = Vector3(0.0f, 0.0f, 0.0f); up = Vector3(0.0f, 1.0f, 0.0f);
	moveSpeed = 100.0f; rotateSpeed = 3.0f;
	nearPlane = 0.2f; farPlane = 150000.0f;
	fov = 0.785398f;
